...
const MainPageDetail = ({ navigation }) => {
  ...
  const getCommentList = async () => {
    try {
      ...
      console.log("MypageDetail.js getCommentList Function Error", error);
      alert("요청에 문제가 있습니다. 잠시후에 다시 요청해주세요.");
    }
  };
  ...
  const writeComment = async () => {
    try {
      ...
      console.log("MypageDetail.js writeComment Function Error", error);
      alert("요청에 문제가 있습니다. 잠시후에 다시 요청해주세요.");
    }
  };
  ...
  const onLike = async board_no => {
    try {
      ...
      console.log("MypageDetail.js onLike Function Error", error);
